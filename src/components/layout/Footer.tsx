...
export function Footer() {
  ...
  return (
    <footer className="bg-slate-950 text-slate-400">
      <div className="container-main grid gap-10 py-16 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed">
            Clínica dental premium en Miraflores, Lima. Más de 10 años transformando
            sonrisas con tecnología de vanguardia y calidez humana.
          </p>
          <ul className="mt-5 space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2.5">
              ...
              <a href={CLINIC.emailHref} className="hover:text-white">{CLINIC.email}</a>
            </li>
            <li className="flex items-center gap-2.5">
          ...
          <div className="mt-5 flex gap-3">
            <Link
              ...
              aria-label="Facebook"
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-900 text-slate-400 transition-colors hover:bg-blue-600 hover:text-white"
            >
            ...
            <Link
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-900 text-slate-400 transition-colors hover:bg-emerald-600 hover:text-white"
            >
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            {FOOTER_SERVICES.map((item) => (
              <li key={item}>
                <a href="#servicios" className="transition-colors hover:text-white">{item}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            {FOOTER_COMPANY.map((item) => (
              <li key={item}>
                <a href="#nosotros" className="transition-colors hover:text-white">{item}</a>
              </li>
            ))}
          </ul>
        </div>
      ...
      <div className="border-t border-slate-800">
        <div className="container-main flex flex-col items-center justify-between gap-3 py-6 text-sm sm:flex-row">
